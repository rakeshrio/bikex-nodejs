const {vehicleDocs,validate} = require('../models/vehicle_docs')
  ...
  upload(req,res,function(err)
    {
      ...
      if(err)
      {
        ...
        let vehicledocs = new vehicleDocs({
            images:req.file.key,
        ...
        vehicledocs = vehicledocs.save(); //saving the docs
         if(err){}
            else
            {
               res.json({'err':0,'msg':'Sucessfully uploaded.'})
            }; 
        };
    });
});
